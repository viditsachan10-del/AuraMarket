...
export const NFT_CONTRACT_ID =
  process.env.NEXT_PUBLIC_NFT_CONTRACT_ID || "CCARXWBBRKC5UIO7DV6EUIJR2KVY3PK24KWXX2ARRJONTH5KCG3O6SEN";

export const MARKETPLACE_CONTRACT_ID =
  process.env.NEXT_PUBLIC_MARKETPLACE_CONTRACT_ID || "CB32CA4O4HWESWP72SANXNVQVMBQ3E5ZNDKYXHNCCBEXO5DHULKBMEMF";
